...
public:
	...
	virtual Long GetID() const { return -1; }//ChatNote
	virtual Long GetWidth() const { return -1; } //ChatNote
	virtual string GetDate() const { return string(""); } //ChatNote
	virtual string GetTime() const { return string(""); } //ChatNote
};
