...
class TextEditingForm : public CWnd, public GlyphSubject {
public:
	TextEditingForm(COLORREF backgroundColor = RGB(255, 255, 255), BOOL isShowScroll = TRUE);
...
protected:
	...
	afx_msg void OnLButtonUp(UINT nFlag, CPoint point); //210423
...
public:
	...
	BOOL GetIsShowScroll() const; //210423
	void SetIsShowScroll(BOOL isShowScroll); //210423
protected:	// 2021.08.25
...
private:
	...
	//생성자 매개변수
	COLORREF backgroundColor; //210423
	BOOL isShowScroll; //210423
};
...
inline COLORREF TextEditingForm::GetBackgroundColor() const {
	return this->backgroundColor;
}

inline void TextEditingForm::SetBackgroundColor(COLORREF backgroundColor) {
	this->backgroundColor = backgroundColor;
}

inline BOOL TextEditingForm::GetIsShowScroll() const {
	return this->isShowScroll;
}

inline void TextEditingForm::SetIsShowScroll(BOOL isShowScroll) {
	this->isShowScroll = isShowScroll;
}
